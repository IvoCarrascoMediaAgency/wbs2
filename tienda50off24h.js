...
const pedido_store = {
    ...
    categories:{
      ...
      items:{
        ...
        'I2':{
            name:'Emprendedor Básico Windows Anual',
            antes:119.99,
            price:59.99,
            qty:0,
            img:'img/whatsbulksender-precio-12-meses-gratis.webp',
            detalles:'<ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Licencia 12 meses</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li><i ></i> Cuentas de WhatsApp ilimitadas</li><li><i ></i> Multidispositivos PC</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación y Exportación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li> <li> <li> <i ></i>Extractor de Contactos</li> <li> <i ></i>Envía Imágenes y Videos con Descripción</li> <li>  <li> <i ></i>Compatible con Todas las Versiones de WhatsApp incluidas las Versiones BETA</li> <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="masc">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación en Marketing Masivo</span></li><li></i>❌Genera Informes de Envíos Masivos.</li><li><li></i>❌Filtro de Números de WhatsApp</li><li><li></i>❌Generador de Números de WhastsApp</li><li><li></i>❌Envíos Masivos a Grupos</li><li><li></i>❌ChatBot Autorespuestas Funnels</li><li><li></i>❌Programar Campañas</li><li><li></i>❌Contestar desde la App</li><li><li></i>❌Transferir a otro Dispositivo</li></ul>',
            linkpago:'https://ppls.me/nROvwvpcUVgORfuNeVClQ',
            },

            'I3':{
              name:'Emprendedor Básico Windows 24 Meses',
              antes:239.99,
              price:119.99,
              qty:0,
...
//   })
  ...
  var whatsapp_number ="&text=*WhatsBulkSender™*" + "%0A"+"✅ _Solicitud Aprobada Prueba N°:_"+ "%20"+orden + "%0A"+"_________________________" + "%0A"+"%0A"+ "*😃 Nombre:*" +"%0A" + nombre + "%20" +"%0A"+"%0A" +"*💼 Nombre del Negocio:*" +"%0A" + nombrenegocio +  "%20" + "%0A"+"%0A"+"*🟢 Versión de Prueba:*"+"%0A" + tipodenegocio + "%20" + "%0A"+"_________________________" + "%0A"+"%0A"+ "*Un especialista se contactará de inmediato para realizar la prueba.*"+ "%0A"+ "%0A"+"*P.D.*"+ "%20"+ "Guarda nuestro contacto como *WhatsBulkSender* para recibir toda la información😉👍";
  ...
  $('#masvendidos').insertBefore('#menu-container-C2');
    ...
    countdown('Jul 30 2022 23:59:59 GMT-0500', 'clock', '¡La Oferta ha expirado, contáctate con soporte!');
