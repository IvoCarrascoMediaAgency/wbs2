...
const pedido_store = {
    ...
    categories:{
      ...
      'C0':{
        items:{
          ...
          'I1':{
              ...
              detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i>1 Licencia 24 horas</li></ul></div></div>',
              linkpago:'',
          ...
          'I2':{
              ...
              'I3':{
                ...
                detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i>1 Licencia 2 años + 2 Meses GRATIS</li></ul></div></div>',
                ...
                'I4':{
                  ...
                  detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i>1 Licencia de por vida</li></ul></div></div>',
      ...
      //       price:119.99,
      //       qty:0,
      //       img:'img/img/win/12-meses-basica.webp',
      //       detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i>  <strong>Multilicencia 12 meses</strong></li><li><i  class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li class="masc"><i ></i> <strong>Cuentas de WhatsApp ilimitadas</strong></li><li class="masc"><i ></i> <strong>Multidispositivos</strong></li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envía Imágenes y Videos con Descripción</li>  <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="masc">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación en Marketing Masivo</span></li></ul></div></div>',
      ...
      //         price:239.99,
      //         qty:0,
      //         img:'img/img/win/24-meses-basica.webp',
      //         detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Multilicencia 24 meses + 2 meses gratis</li><li><i  class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li class="masc"><i ></i> <strong>Cuentas de WhatsApp ilimitadas</strong></li><li class="masc"><i ></i> <strong>Multidispositivos</strong></li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envía Imágenes y Videos con Descripción</li>  <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="masc">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación en Marketing Masivo</span></li></div></div>',
      ...
      //           price:299.99,
      //           qty:0,
      //           img:'img/img/win/lifeteime-basica.webp',
      //           detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Multilicencia de por vida</li><li><i  class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li class="masc"><i ></i> <strong>Cuentas de WhatsApp ilimitadas</strong></li><li class="masc"><i ></i> <strong>Multidispositivos</strong></li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envía Imágenes y Videos con Descripción</li>  <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="masc">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación en Marketing Masivo</span></li></ul></div></div>',
      ...
      //           price:39.99,
      //           qty:0,
      //           img:'img/img/win/1-mes-pro.webp',
      
      //           detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Multilicencia PRO Business 30 días</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación y Exportación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envia Imágenes y Videos con Descripción</li> <li>  <li> <i ></i>Con funciones para WhatsApp Business</li> <li> <li> <li> <span class="">Soporte</span></li><li><span class="">Actualizaciones GRATIS</span></li><li><span class="">Capacitación en WhatsApp Masivo</span></li><li></i>✅Genera Informes de Envíos Masivos.</li><li> <li> <i ></i>✅Extractor de Contactos</li><li><li></i>✅Filtro de Números de WhatsApp</li><li><li></i>✅Envíos Masivos a Grupos y Etiquetados</li><li><li></i>✅ChatBot Autorespuestas Funnels</li><li><li></i>✅Transferir a otro Dispositivo</li></ul></div></div>',
      ...
      //           price:239.99,
      //           qty:0,
      //           img:'img/img/win/12-meses-pro.webp',
      //           detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Multilicencia PRO Business 12 meses</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li class="masc"><i ></i> Cuentas de WhatsApp ilimitadas</li><li class="masc"><i ></i> Multidispositivos</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación y Exportación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envia Imágenes y Videos con Descripción</li> <li>  <li> <i ></i>Con funciones para WhatsApp Business</li> <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación personalizada en WhatsApp Masivo</span></li><li></i>✅Genera Informes de Envíos Masivos.</li></li><li></i>✅Filtro de Números de WhatsApp</li><li ><li class="masc"></i>✅Extractor de Contactos, Grupos y Etiquetados</li><li ><li class="masc"></i>✅Entrenador de Números de WhastsApp</li><li><li></i>✅Envíos Masivos a Grupos y Etiquetados</li><li><li></i>✅ChatBot Autorespuestas Funnels</li><li><li></i>✅Transferir a otro Dispositivo</li></ul></div></div>',
      ...
      //             price:479.99,
      //             qty:0,
      //             img:'img/img/win/24-meses-pro.webp',
      //             detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Multilicencia PRO Business 24 meses+ 2 meses gratis</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li class="masc"><i ></i> Cuentas de WhatsApp ilimitadas</li><li class="masc"><i ></i> Multidispositivos</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación y Exportación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envia Imágenes y Videos con Descripción</li> <li>  <li> <i ></i>Con funciones para WhatsApp Business</li> <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación personalizada en WhatsApp Masivo</span></li><li></i>✅Genera Informes de Envíos Masivos.</li></li><li></i>✅Filtro de Números de WhatsApp</li><li ><li class="masc"></i>✅Extractor de Contactos, Grupos y Etiquetados</li><li ><li class="masc"></i>✅Entrenador de Números de WhastsApp</li><li><li></i>✅Envíos Masivos a Grupos y Etiquetados</li><li><li></i>✅ChatBot Autorespuestas Funnels</li><li><li></i>✅Transferir a otro Dispositivo</li></ul></div></div>',
      ...
      //               price:599.99,
      //               qty:0,
      //               img:'img/img/win/lifetime-pro.webp',
      //               detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i> Multilicencia PRO Business LifeTime</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li class="masc"><i ></i> Cuentas de WhatsApp ilimitadas</li><li class="masc"><i ></i> Multidispositivos</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación y Exportación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envia Imágenes y Videos con Descripción</li> <li>  <li> <i ></i>Con funciones para WhatsApp Business</li> <li> <li> <li> <span class="masc">Soporte 24/7</span></li><li><span class="">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación personalizada en WhatsApp Masivo</span></li><li></i>✅Genera Informes de Envíos Masivos.</li></li><li></i>✅Filtro de Números de WhatsApp</li><li ><li class="masc"></i>✅Extractor de Contactos, Grupos y Etiquetados</li><li ><li class="masc"></i>✅Entrenador de Números de WhastsApp</li><li><li></i>✅Envíos Masivos a Grupos y Etiquetados</li><li><li></i>✅ChatBot Autorespuestas Funnels</li><li><li></i>✅Transferir a otro Dispositivo</li></ul></div></div>',
    ...
    'C3':{
      items:{
         ...
         'I1':{
             ...
             price:199.99,
             qty:0,
             img:'img/img/pc/franquiciado.webp',
         ...
         'I2':{
             ...
             price:399.99,
             qty:0,
             img:'img/img/pc/marca-blanca.webp',
...
comicpay.style.display = 'block';
  ...
  for (var i = 0, length = radios.length; i < length; i++) {
    if (radios[i].checked) {
      ...
      var cambio="%0A%20"+ document.getElementById('entry.580204725').textContent;
...
//pepon
  ...
  var whatsapp_number ="&text=*Orden exitosa*" + "%0A"+"*WhatsBulkSender-2024*"+ "%0A"+"✅ *Detalle de la orden:*"+"%0A"+"_Orden N°_"+"%20"+ "%20"+"---"+"%20"+orden+"%20"+"---"+ "%0A"+"_________________________" + "%0A"+mostrarpedidof+ "%0A"+"*Total:*"+ "%20"+ "$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+ "%0A"+"_________________________"+ "%0A"+'*🙂Datos del Cliente:*'+ "%0A"+mostrarfac+"%20"+mostrarcedula+nombre+email+whatsapp+"%20"+"_________________________" +"%0A"+ retornapagos+cambio+"%0A"+fanlink+"%20"+"%0A"+"*Total:*"+ "%20"+"$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+"%0A"+"%0A"+"*Orden N°:*"+ "%20"+orden;
